...
export function removeAllCss() {
    let cssList = [
        `${VUE_APP_RES_URL}/style/theme/theme_default.css`,
        `${VUE_APP_RES_URL}/style/theme/theme_eye.css`,
        `${VUE_APP_RES_URL}/style/theme/theme_gold.css`,
        `${VUE_APP_RES_URL}/style/theme/theme_night.css`
    ]
